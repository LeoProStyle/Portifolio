...
const AddAlbum = () => {
    ...
    const [colour,setColour] = useState("#363636");
  ...
  return loading ? (
    ...
    <div className='flex flex-col gap-3'>
      <p>Plano de fundo do album</p>
      <input  onChange={(e)=>setColour(e.target.value)} value={colour} type='color' />
    </div>

    <button className='text-base bg-black text-white py-2.5 px-14 cursor-pointer' type="submit">Adicionar</button>
    </form>
  )
}
