      ...
      <div className="overflow-x-auto rounded-xl border border-zinc-200 dark:border-zinc-800">
        <table className="w-full text-sm">
          ...
          <tbody>
            {loading ? (
              <tr>
                <td colSpan={4} className="px-4 py-6 text-center text-zinc-500">Carregando...</td>
              </tr>
            ) : error ? (
              <tr>
              ...
              <tr>
                <td colSpan={8} className="px-4 py-6 text-center text-zinc-500">Nenhuma nota de compra encontrada.</td>
              </tr>
            ) : (
              items.map((item) => (
